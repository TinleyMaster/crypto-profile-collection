...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Refresh biz.doc_source_entry from mapped CG coin_info URLs."
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
...
def main() -> int:
    ...
    from crypto_research.mapping.cg_doc_source_entries import extract_cg_doc_source_entries

    settings = get_settings(require_database=True)
    select_candidates_sql = load_sql("src_cg/select_cg_doc_source_candidates.sql")

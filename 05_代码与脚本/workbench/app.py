...
TASK_DEFS = {
    ...
    "relabel_github_links": {
        "name": "GitHub 链接批量重标",
        "description": "将 entry_url 含 github.com 的链接统一重标为 github，并回滚 github.io 误标",
        "script": "relabel_link_types.py",
        "default_args": ["--type", "github"],
        "category": "维护",
        "hidden": True,
    },
    "relabel_whitepaper_links": {
        "name": "白皮书链接批量重标",
        "description": "将 entry_url 含 whitepaper/litepaper 的链接统一重标为 whitepaper_page",
        "script": "relabel_link_types.py",
        "default_args": ["--type", "whitepaper"],
        "category": "维护",
        "hidden": True,
    },
    "cleanup_thesis_duplicates": {
        "name": "清理 thesis 重复行",
        "description": "删除 biz.research_thesis 中按 (asset_id, source_notebook_id) 重复的较旧记录",
        "script": "relabel_link_types.py",
        "default_args": ["--cleanup-thesis-duplicates"],
        "category": "维护",
        "hidden": True,
    },
    "ingest_dl_tvl_daily": {
